...
public class Record1 {
    ...
    private static final String AUDIO_RECORDER_FILE_EXT_WAV = "AudioRecorder2.wav";
    private static final String AUDIO_RECORDER_FOLDER = "AudioRecorder";
    private static final String AUDIO_RECORDER_TEMP_FILE = "record_temp2.raw";
    ...
    //Constructor
    public Record1(String uniquename) {
